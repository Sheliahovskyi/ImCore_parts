 ...
 * \author Шлапак Игорь
 * \date 25.10.2018
 * \brief Класс-буфер для обмена информацией между парралельными потоками
 *
 * Позволяет проводить обмен данными между компонентами ImCore. Защищает данные от потери
 *
 */
